...
OBJECTS := \
	$(OBJDIR)/AkToneGenDSP.o \
	$(OBJDIR)/AkToneGenParams.o \
	$(OBJDIR)/AkLpFilter.o \
	$(OBJDIR)/AkToneGen.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking AkToneSourceLinux
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning AkToneSourceLinux
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/AkToneGenDSP.o: ../AkToneGenDSP.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/AkToneGenParams.o: ../AkToneGenParams.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/AkLpFilter.o: ../AkLpFilter.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/AkToneGen.o: ../AkToneGen.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
